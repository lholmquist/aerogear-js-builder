...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            dist: {
                src: ['<banner:meta.banner>', '<file_strip_banner:aerogear-js/aerogear.core.js>', '<file_strip_banner:aerogear-js/utilities/aerogear.utilities.js>', '<file_strip_banner:aerogear-js/pipeline/aerogear.pipeline.js>', '<file_strip_banner:aerogear-js/pipeline/adapters/rest.js>', '<file_strip_banner:aerogear-js/data-manager/aerogear.datamanager.js>', '<file_strip_banner:aerogear-js/data-manager/adapters/memory.js>', '<file_strip_banner:aerogear-js/authentication/aerogear.auth.js>', '<file_strip_banner:aerogear-js/authentication/adapters/rest.js>'],
